// AWS SDK for JavaScript v2.0.17
...
},{"./core":3,"./state_machine":42,"Zbi7gb":57}],31:[function(require,module,exports){
...
},{"./core":3,"Zbi7gb":57,"buffer":46,"crypto":50,"querystring":61,"url":62}],44:[function(require,module,exports){
var util = require('../util');
var Shape = require('../model/shape');
...
},{"./support/isBuffer":63,"Zbi7gb":57,"inherits":56}],65:[function(require,module,exports){
(function() {
...
},{"./XMLBuilder":65}]},{},[1]);AWS.AutoScaling = AWS.Service.defineService('autoscaling');

AWS.CloudFormation = AWS.Service.defineService('cloudformation');

AWS.CloudFront = AWS.Service.defineService('cloudfront');

AWS.CloudSearch = AWS.Service.defineService('cloudsearch');

AWS.CloudSearchDomain = AWS.Service.defineService('cloudsearchdomain');
...
AWS.CloudWatch = AWS.Service.defineService('cloudwatch');

AWS.CloudWatchLogs = AWS.Service.defineService('cloudwatchlogs');
...
AWS.DataPipeline = AWS.Service.defineService('datapipeline');

AWS.DirectConnect = AWS.Service.defineService('directconnect');
...
AWS.EC2 = AWS.Service.defineService('ec2');
...
AWS.ElasticBeanstalk = AWS.Service.defineService('elasticbeanstalk');

AWS.ELB = AWS.Service.defineService('elb');
...
AWS.IAM = AWS.Service.defineService('iam');
...
AWS.RDS = AWS.Service.defineService('rds');

AWS.Redshift = AWS.Service.defineService('redshift');

AWS.Route53 = AWS.Service.defineService('route53');
...
AWS.Route53Domains = AWS.Service.defineService('route53domains');
...
AWS.SES = AWS.Service.defineService('ses');
...
AWS.SWF = AWS.Service.defineService('swf');
